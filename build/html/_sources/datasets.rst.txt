...
The full corpus of Wikipedia talk page conversations. Due to size, split by year.
...
Conversations from developers reviewing proposed code changes in the Chromium project.
...
Transcripts of tennis singles post-match press conferences for major tournaments (2007-2015).
...
ChangeMyView conversations with delta (success) information for convincing arguments.
...
Reddit conversations manually annotated with discourse act labels.
...
Online conversations where one participant tries to convince another to donate to charity.
...
Transcripts of Intelligence Squared Debates.
...
All conversations from 10 seasons of the TV sitcom Friends (1990s).
...
Transcripts of Federal Reserve FOMC meetings (1977-2008).
...
Conversations between NPR show hosts and guests.
...
Multi-party problem-solving conversations with team performance information.
...
1,155 five-minute telephone conversations annotated with speech act tags.
...
.. raw:: html
   ...
   <div class="dataset-card" data-tags="medium size, asynchronous, Wikipedia, utterance labels, online, short conversations, politeness">

Wikipedia and Stackrequests with politeness annotations.
...
.. raw:: html
   ...
   <div class="dataset-card" data-tags="medium size, asynchronous, Stack Exchange, utterance labels, online, politeness">

Stack Exchange requests with politeness annotations.

* **Download name:** ``stack-exchange-politeness-corpus``
* **Tags:** medium size, asynchronous, Stack Exchange, utterance labels, online, politeness
...
17,000+ messages with intended and perceived deception labels.
...
28 group meetings (84 participants) in decision-making exercises.
...
Wikipedia's Articles for Deletion editor debates (2005-2018).
...
1,030 negotiation dialogues about campsite resource allocation.
...
68,000+ "Yes, and" improvisation utterance pairs from podcasts and movies.
